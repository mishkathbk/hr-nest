...
const create_salary_type_dto_1 = require("./dto/create-salary-type.dto");
const update_salary_type_dto_1 = require("./dto/update-salary-type.dto");
const pagination_salary_type_dto_1 = require("./dto/pagination-salary-type.dto");
let SalaryTypeController = class SalaryTypeController {
    constructor(salaryTypeService) {
...
exports.SalaryTypeController = SalaryTypeController;
__decorate([
...
], SalaryTypeController.prototype, "listSearch", null);
__decorate([
    ...
    __param(1, (0, user_decorator_1.CurrentUser)("companyId")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [pagination_salary_type_dto_1.PaginationSalaryTypeDto, Number]),
    __metadata("design:returntype", void 0)
], SalaryTypeController.prototype, "listPagination", null);
__decorate([
    (0, common_1.Get)(),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], SalaryTypeController.prototype, "getByKey", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_salary_type_dto_1.CreateSalaryTypeDto, Number, Number]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, update_salary_type_dto_1.UpdateSalaryTypeDto, Number, Number]),
    __metadata("design:returntype", void 0)
...
exports.SalaryTypeController = SalaryTypeController = __decorate([
    (0, common_1.Controller)("salary-type"),
