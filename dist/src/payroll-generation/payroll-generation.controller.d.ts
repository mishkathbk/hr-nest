...
export declare class PayrollGenerationController {
    private readonly payrollGenerationService;
    constructor(payrollGenerationService: PayrollGenerationService);
    ...
    getPayrollDetail(id: number, companyId: number): Promise<{
        payrollgenerationid: number;
        employee: {
            hrm_department: {
                departmentname: string;
